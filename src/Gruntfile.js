...
module.exports = function (grunt) {
    ...
    var idevelasConfig = {
        ...
        uglify: {
            dist: {
                files: {
                    '<%= dirs.js %>/idevelas.min.js': [
                        '<%= dirs.js %>/idevelas.js'    // Custom JavaScript
                    ],
                    '<%= dirs.js %>/idevelas-admin.min.js': [
                        '<%= dirs.js %>/idevelas-admin.js'    // Custom JavaScript
                    ]
                }
            }
        },
    ...
    // --------------------------
    grunt.initConfig(idevelasConfig);
